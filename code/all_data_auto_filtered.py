...
#d=r"C:\Users\Ash kan\Documents\meteo_iso_model_input_code_and_results\case_studies\salar_de_atacama\all_data_auto_filtered"
...
preped_prc.fit(inp_var=rain,var_name="prc",fields=["CooX","CooY","CooZ"],remove_outliers=True,IQR_inp_var=False,q1=0,direc=ddir_inp_classess)

#Temperature
preped_tmp=preprocess()
preped_tmp.fit(inp_var=temp,var_name="tmp",fields=["CooX","CooY","CooZ"],remove_outliers=True,IQR_inp_var=False,direc=ddir_inp_classess)

#Humidity
preped_hmd=preprocess()
preped_hmd.fit(inp_var=hum,var_name="hmd",fields=["CooX","CooY","CooZ"],remove_outliers=True,IQR_inp_var=False,direc=ddir_inp_classess)

#isotopes
prep_st2_iso1=preprocess()
prep_st2_iso1.fit(inp_var=iso_18,var_name="is1",fields=["CooX","CooY","CooZ"],remove_outliers=False,direc=ddir_inp_classess)

prep_st2_iso2=preprocess()
prep_st2_iso2.fit(inp_var=iso_2h,var_name="is2",fields=["CooX","CooY","CooZ"],remove_outliers=False,direc=ddir_inp_classess)
...
#stage 1 prediction
est_class.st1_predict(cls_list=[prep_st2_iso1,prep_st2_iso2,prep_st2_iso3],st2_model_month_list=[1,2,3])
#-------------------------------------------

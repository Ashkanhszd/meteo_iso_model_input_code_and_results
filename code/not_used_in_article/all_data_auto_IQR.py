...
#importing data
d=join("case_studies","salar_de_atacama","all_data_auto_IQR")
...
preped_prc.fit(inp_var=rain,var_name="prc",fields=["CooX","CooY","CooZ"],remove_outliers=True,IQR_inp_var=True,direc=ddir_inp_classess)
